...
|----------------------------------------|----------------------------------|----------------------------------------------------------------------------------------------------------------------------|--------------|-----------------|-----------------|-------|-----------|-----------|
| `SPEC-HARDENING-V1`                    | Hardening, security and resilience v1 | [`hardening-resilience-v1.md`](../specs/features/hardening-resilience-v1.md)                                         | `REVIEW`     | `maintainer/security` | `2026-08-07`    | `ADR-0001`–`ADR-0003` (planned) | F7        | Normativa |
...
| `SPEC-PRODUCT-V1`                      | SafeCube v1 product brief        | [`v1-product-brief.md`](../specs/product/v1-product-brief.md)                                                              | `APPROVED`   | `product`       | `2026-07-29`    | `N/A` | F0-10     | Normativa |
