...
| `SPEC-TESTING`                | `NFR-QUALITY-001` | `SCDK-M94`  | Gradle, recursos Android y tests | `./gradlew clean lintDebug` | `PARTIAL` | Cero errores y sin baseline/suppressions; quedan 28 avisos advisory de versiones de Gradle/AGP/dependencias, fuera de alcance de M94 y previstos para la tarea 09; instrumented y cobertura siguen pendientes |
