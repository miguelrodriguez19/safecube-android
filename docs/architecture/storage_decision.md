...
|----------------|------------|-----------|---------------|------------|--------------|
| `SPEC-STORAGE` | `APPROVED` | `storage` | `2026-07-29`  | `N/A`      | `N/A`        |
...
The project needs an offline-first local persistence strategy that is stable, testable, and well
integrated with the Android ecosystem.
...
- SQLDelight: strong option, but Room gives a simpler path with Android-native conventions for this
  project phase.
