...
| `SPEC-TESTING`                | `NFR-QUALITY-001` | `SCDK-M94`  | Gradle, recursos Android y tests | `./gradlew lintDebug` | `IMPLEMENTED` | Lint debug pasa sin baseline ni suppressions; instrumented y cobertura siguen pendientes |
