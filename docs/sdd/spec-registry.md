...
|----------------------------------------|----------------------------------|----------------------------------------------------------------------------------------------------------------------------|--------------|-----------------|-----------------|-------|-----------|-----------|
| `SPEC-HARDENING-V1`                    | Hardening, security and resilience v1 | [`hardening-resilience-v1.md`](../specs/features/hardening-resilience-v1.md)                                         | `APPROVED`   | `maintainer/security` | `2026-08-10`    | [`ADR-0001`](../architecture/adr/ADR-0001-VAULT-AUTO-LOCK.md) `ACCEPTED`; ADR-0002–ADR-0003 planned | F7        | Normativa |
