# FASE 5 - Sync Incremental Multi-Device v1

> Historical roadmap. This document describes the original timestamp-based synchronization
> proposal and is retained for context only. It is superseded by the current
> [Vault Sync Versioning v2 ADR](../../architecture/vault-sync-versioning-v2.md) and the current
> [Fase 5 roadmap](../roadmap--fase-5.md).
